...
@Component({
  selector: 'app-table-view3',
  templateUrl: './table-view3.component.html',
  styleUrls: ['./table-view3.component.css']
})
export class TableView3Component implements OnInit {
  DEPOT_ALL: any = [];
  DEPOT_CODE: any = [];
  DEPOT_CODE_2: any = [];
  DEPOT_CODE_NAME: any = {};
  ...
  LoadTableData(Event:any,data:any) {
    if (this.Validation.isEmptyObject2(data, ['Select Month', 'Select Year'], Event)) {
      ...
      data['Last_day'] = date_List.LastDay;
      this.service.DSR_Report_3(data);
      this.PreviewData.setData('DSR_REPORT_3', data);
    }
  }
  TDate() {
